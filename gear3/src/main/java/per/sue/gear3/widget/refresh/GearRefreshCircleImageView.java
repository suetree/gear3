...
public class GearRefreshCircleImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public GearRefreshCircleImageView(Context context, int color) {
        super(context);
    ...
    private class OvalShadow extends OvalShape {
        ...
        OvalShadow(int shadowRadius) {
            GearRefreshCircleImageView.this.mShadowRadius = shadowRadius;
        ...
        public void draw(Canvas canvas, Paint paint) {
            int viewWidth = GearRefreshCircleImageView.this.getWidth();
            int viewHeight = GearRefreshCircleImageView.this.getHeight();
            canvas.drawCircle((float)(viewWidth / 2), (float)(viewHeight / 2), (float)(viewWidth / 2), this.mShadowPaint);
            canvas.drawCircle((float)(viewWidth / 2), (float)(viewHeight / 2), (float)(viewWidth / 2 - GearRefreshCircleImageView.this.mShadowRadius), paint);
        }

        private void updateRadialGradient(int diameter) {
            this.mRadialGradient = new RadialGradient((float)(diameter / 2), (float)(diameter / 2), (float) GearRefreshCircleImageView.this.mShadowRadius, new int[]{1023410176, 0}, (float[])null, Shader.TileMode.CLAMP);
